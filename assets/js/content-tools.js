...
(function() {
  ...
  window.ContentTools = {
    Tools: {},
    DEFAULT_TOOLS: [['bold', 'italic', 'link', 'align-left', 'align-center', 'align-right'], ['heading', 'heading2', 'heading3', 'heading4', 'heading5', 'paragraph', 'unordered-list', 'ordered-list', 'table', 'line-break', 'image', 'video'], ['undo', 'redo', 'remove']],
